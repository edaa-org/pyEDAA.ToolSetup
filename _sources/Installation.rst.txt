.. |PackageName| replace:: pyEDAA.SetupTool
      ...
      .. tab-set::
         ...
         .. tab-item:: Minimal installation
            ...
            .. code-block:: bash
               ...
               # Basic pyEDAA.SetupTool package
               pip3 install pyEDAA.SetupTool

               # Alternatively
               python3 -m pip install pyEDAA.SetupTool
         ...
         .. tab-item:: With Documentation Dependencies
            ...
            .. code-block:: bash
               ...
               pip3 install pyEDAA.SetupTool[doc]

               # Alternatively
               python3 -m pip install pyEDAA.SetupTool[doc]
         ...
         .. tab-item:: With Unit Testing Dependencies
            ...
            .. code-block:: bash
               ...
               pip3 install pyEDAA.SetupTool[test]

               # Alternatively
               python3 -m pip install pyEDAA.SetupTool[test]
         ...
         .. tab-item:: All Developer Dependencies
            ...
            .. code-block:: bash
               ...
               pip3 install pyEDAA.SetupTool[all]

               # Alternatively
               python3 -m pip install pyEDAA.SetupTool[all]
      ...
      .. tab-set::
         ...
         .. tab-item:: Minimal installation
            ...
            .. code-block:: powershell
               ...
               # Basic pyEDAA.SetupTool package
               pip install pyEDAA.SetupTool

               # Alternatively
               py -m pip install pyEDAA.SetupTool
         ...
         .. tab-item:: With Documentation Dependencies
            ...
            .. code-block:: powershell
               ...
               # Install with dependencies to generate documentation
               pip install pyEDAA.SetupTool[doc]

               # Alternatively
               py -m pip install pyEDAA.SetupTool[doc]
         ...
         .. tab-item:: With Unit Testing Dependencies
            ...
            .. code-block:: powershell
               ...
               # Install with dependencies to run unit tests
               pip install pyEDAA.SetupTool[test]

               # Alternatively
               py -m pip install pyEDAA.SetupTool[test]
         ...
         .. tab-item:: All Developer Dependencies
            ...
            .. code-block:: powershell
               ...
               # Install with all developer dependencies
               pip install pyEDAA.SetupTool[all]

               # Alternatively
               py -m pip install pyEDAA.SetupTool[all]
...
.. tab-set::
   ...
   .. tab-item:: Linux/macOS
      ...
      .. code-block:: bash
         ...
         # Update pyEDAA.SetupTool
         pip3 install -U pyEDAA.SetupTool

         # Alternatively
         python3 -m pip install -U pyEDAA.SetupTool
   ...
   .. tab-item:: Windows
      ...
      .. code-block:: powershell
         ...
         # Update pyEDAA.SetupTool
         pip install -U pyEDAA.SetupTool

         # Alternatively
         py -m pip install -U pyEDAA.SetupTool
...
.. tab-set::
   ...
   .. tab-item:: Linux/macOS
      ...
      .. code-block:: bash
         ...
         # Uninstall pyEDAA.SetupTool
         pip3 uninstall pyEDAA.SetupTool

         # Alternatively
         python3 -m pip uninstall pyEDAA.SetupTool
   ...
   .. tab-item:: Windows
      ...
      .. code-block:: powershell
         ...
         # Uninstall pyEDAA.SetupTool
         pip uninstall pyEDAA.SetupTool

         # Alternatively
         py -m pip uninstall pyEDAA.SetupTool
...
.. tab-set::
   ...
   .. tab-item:: Linux/macOS
      ...
      .. code-block:: bash
         ...
         python3 -m pip uninstall -y pyEDAA.SetupTool

         # Install from wheel
         python3 -m pip install ./dist/pyEDAA.SetupTool-0.3.0-py3-none-any.whl
   ...
   .. tab-item:: Windows
      ...
      .. code-block:: powershell
         ...
         # Uninstall the old package
         py -m pip uninstall -y pyEDAA.SetupTool

         # Install from wheel
         py -m pip install .\dist\pyEDAA.SetupTool-0.3.0-py3-none-any.whl
