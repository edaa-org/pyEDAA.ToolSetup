...
# ==============================================================================
extlinks = {
	"ghissue": ("https://GitHub.com/edaa-org/pyEDAA.ToolSetup/issues/%s", "issue #%s"),
	"ghpull":  ("https://GitHub.com/edaa-org/pyEDAA.ToolSetup/pull/%s", "pull request #%s"),
	"ghsrc":   ("https://GitHub.com/edaa-org/pyEDAA.ToolSetup/blob/main/%s", None),
}
